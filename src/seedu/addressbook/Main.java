...
import static seedu.addressbook.common.Messages.MESSAGE_DONOT_DELETE_FILE;
...
public class Main {
	...
	private void runCommandLoopUntilExitCommand() {
		...
		do {
			...
			checkIfTheAddressbookFileExist();
	...
	public void checkIfTheAddressbookFileExist() {
		File f = new File(DEFAULT_STORAGE_FILEPATH);
		if (!f.exists()) {
			CommandResult warningMessage = new CommandResult (MESSAGE_DONOT_DELETE_FILE);
			ui.showResultToUser(warningMessage);
		}
	}
